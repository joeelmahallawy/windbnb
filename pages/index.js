...
function Search() {
  ...
  const [curLocation, setCurLocation] = useState("Helsinki, Finland");
  const [adultCounter, setAdultCounter] = React.useState(0);
  const [childrenCounter, setChildrenCounter] = React.useState(0);
  const parentOfModal = useRef();
  return (
    <>
      <div id="parentOfModal" ref={parentOfModal}>
        <div className={classnames({ [styles.searchOptionsContainer]: true })}>
          <button className={classnames({ [styles.closeSearch]: true })}>
          ...
          <div className={classnames({ [styles.searchFields]: true })}>
            ...
            <button>
              <div className={classnames({ [styles.searchSearch]: true })}>
          ...
          <div className={classnames({ [styles.options]: true })}>
            {locationState && (
              <ul className={classnames({ [styles.locationOptions]: true })}>
                <li>
                  <MdPlace
            ...
            {guestState && (
              <div className={classnames({ [styles.guestOptions]: true })}>
                <div className={classnames({ [styles.adultContainer]: true })}>
                  ...
                  <div className={classnames({ [styles.adultCounter]: true })}>
                    <button
                ...
                <div className={classnames({ [styles.childrenCounter]: true })}>
                  <button
                    className={classnames({ [styles.decrement]: true })}
                    onClick={() =>
                      setChildrenCounter(childrenCounter && childrenCounter - 1)
                    }
                  >
                    &mdash;
                  </button>
    ...
    <>
      ...
      >
        ...
        >
          ...
          <button className={classnames({ [styles.guestsBtn]: true })}>
            Add Guests
          </button>
          <button className={classnames({ [styles.searchBtn]: true })}>
